...
DEFAULT_ARTICLE_TYPES = "Sport,International,Web,Panorama,Wirtschaft,Inland,Etat,Wissenschaft,Kultur"
...
if __name__ == '__main__':
    ...
    parser.add_argument(dest="article_type", action="store", help="A list of article types comma-delimited (e.g. Sport,International")
...
def handle_article_types(query_string, delimiter=','):
    """

    :param query_string: The list of article types to be
    :param delimiter:
    :return:
    """
